import Sonam from '../assets/images/sonam.png'
const Sidebar = () => {
  return (
    <>
      <div className='bg-violet-800 min-h-screen p-3 text-white'>
        <div className='flex justify-center mt-2'>
          <img src={Sonam} alt="Sonam" className='w-36 h-36 rounded-full' />
        </div>
        ...
        <div className="flex items-center gap-1 mt-2">
          ...
          <a href="https://github.com/geekyshow1" target="_blank" rel="noreferrer" className="text-gray-100">github.com/geekyshow1</a>
        </div>
